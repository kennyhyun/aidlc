...
because the log is massive, download it in the `.files` directory, for example, docs/tickets/task/REI-14976_kioskdecide-the-kiosk-rendering-and-launch-the-rendering-app-minimised/.files
