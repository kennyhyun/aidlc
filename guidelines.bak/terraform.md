...
- Example: https://gitlab.imaginetoolbox.com/whitech-group/development/reimagine/imagine-online/-/terraform
...
terraform {
  backend "http" {
    address        = "https://gitlab.imaginetoolbox.com/api/v4/projects/${PROJECT_ID}/terraform/state/${STATE_NAME}"
    lock_address   = "https://gitlab.imaginetoolbox.com/api/v4/projects/${PROJECT_ID}/terraform/state/${STATE_NAME}/lock"
    unlock_address = "https://gitlab.imaginetoolbox.com/api/v4/projects/${PROJECT_ID}/terraform/state/${STATE_NAME}/lock"
      ...
      template:
        spec:
          ...
          - name: trigger
            ...
            - |
              curl -X POST \
                "https://gitlab.imaginetoolbox.com/api/v4/projects/${PROJECT_ID}/trigger/pipeline" \
